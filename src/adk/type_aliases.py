...
NetworkNameType = Dict[str, DefaultPayloadType]
NetworkListType = List[NetworkNameType]
...
UserType = Dict[str, DefaultPayloadType]
...
BackendTypeType = Dict[str, Union[DefaultPayloadType, bool, NetworkListType]]
